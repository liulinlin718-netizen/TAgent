// Open a fresh CLI browser at about:blank?mcpFixture=<isolated backend base> first.
async (page) => {
  ...
  await page.goto(`http://127.0.0.1:3000/management/mcp?mcpFixture=${encodeURIComponent(base)}`);
